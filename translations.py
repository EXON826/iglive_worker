...
TRANSLATIONS = {
    'en': {
        ...
        'smart_points_desc': 'Get 3 free points daily',
        'refer_earn': '🎁 *Refer & Earn*',
        'refer_earn_desc': '5 bonus points per referral',
    ...
    'ru': {
        ...
        'smart_points_desc': 'Получайте 3 бесплатных очков ежедневно',
        'refer_earn': '🎁 *Приглашайте и зарабатывайте*',
        'refer_earn_desc': '5 бонусных очков за реферала',
    ...
    'es': {
        ...
        'smart_points_desc': 'Obtén 3 puntos gratis diarios',
        'refer_earn': '🎁 *Refiere y gana*',
        'refer_earn_desc': '5 puntos extra por referido',
    ...
    'pt': {
        ...
        'smart_points_desc': 'Ganhe 3 pontos grátis diariamente',
        'refer_earn': '🎁 *Indique e ganhe*',
        'refer_earn_desc': '5 pontos extras por indicação',
    ...
    'it': {
        ...
        'smart_points_desc': 'Ottieni 3 punti gratis al giorno',
        'refer_earn': '🎁 *Invita e guadagna*',
        'refer_earn_desc': '5 punti bonus per referral',
    ...
    'fr': {
        ...
        'smart_points_desc': 'Obtenez 3 points gratuits par jour',
        'refer_earn': '🎁 *Parrainez et gagnez*',
        'refer_earn_desc': '5 points bonus par parrainage',
